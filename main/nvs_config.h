...
namespace Config {
    ...
    inline uint16_t getThrottleTemp() { return cfgGetU16(NVS_CONFIG_THROTTLE_TEMP, 65); }
    ...
    inline void setThrottleTemp(uint16_t value) { cfgSetU16(NVS_CONFIG_THROTTLE_TEMP, value); }
    ...
    inline bool isAutoThrottleEnabled() { return cfgGetU16(NVS_CONFIG_THROTTLE_ENABLE, 0) != 0; }
    ...
    inline void setAutoThrottleEnabled(bool value) { cfgSetU16(NVS_CONFIG_THROTTLE_ENABLE, value ? 1 : 0); }
